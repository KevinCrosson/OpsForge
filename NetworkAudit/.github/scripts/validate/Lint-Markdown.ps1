...
.DESCRIPTION
    Validates that Markdown headings progress without skipping levels (e.g., H1 ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ H2 ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ H3).
...
foreach ($Line in $Content) {
    ...
    if ($Line -match '^#{1,6}\s') {
        ...
        # Detect heading level jump (e.g., H1 ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ H3)
        if ($Level -gt ($LastLevel + 1)) {
            if ($Fix) {
                # Auto-correct heading level to next valid level
                $Corrected = ('#' * ($LastLevel + 1)) + ($Line -replace '^#{1,6}', '')
                Write-Host "Fixed heading: $Line ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ $Corrected"
