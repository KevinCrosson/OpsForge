...
foreach ($conn in $connections) {
    # ÃƒÆ'Ã‚Â degÃƒ...Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â Extract connection details
    ...
    $target  = "${localIP}:${localPort} ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ ${remoteIP}:${remotePort}"
